...
class AWS:
    def __init__(self):
        ...
        CTkLabel(self.janela, text=self.version).place(x=220, y=230)
    ...
    def app(self):
        ...
        self.objetos_listbox = CTkTextbox(self.home, width=800, height=300)
        ...
        CTkButton(self.home, text='Verificar Objetos', command=self.verificar_objetos_especificos).place(x=20, y=350)
    ...
    def verificar_objetos_especificos(self):
        ...
        buckets_objetos_esperados = {
            'gacc-backup-bancos-sem-versionamento': ['Acessonet2008.bak', 'BK_CorporeRM.bak', 'BK_TAF.bak',
                                                     'BK_TSS.bak', 'Backup_SECRETARIA.7z',
                                                     'Backup_TELEMARKETING.7z', 'Bitlab2008.bak',
                                                     'MAssistencial2008.bak', 'Pontosecullum42008.BAK',
                                                     'SAUBER.bak', 'webcalendar2008.bak'],
            'gacc-backup-tsv-fusion': ['BK_FUSION_BASE0.bak', 'TSV.bak'],
            'gacc-backup-bancos': []
        }
